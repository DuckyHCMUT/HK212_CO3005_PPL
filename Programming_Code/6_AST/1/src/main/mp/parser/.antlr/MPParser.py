...
class MPParser ( Parser ):
    ...
    class VardeclsContext(ParserRuleContext):
        ...
        def vardecltail(self):
            return self.getTypedRuleContext(MPParser.VardecltailContext,0)
    ...
    class VardecltailContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MPParser.RULE_vardecltail
    ...
    def vardecltail(self):
        ...
        localctx = MPParser.VardecltailContext(self, self._ctx, self.state)
        self.enterRule(localctx, 4, self.RULE_vardecltail)
        try:
            self.state = 22
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [MPParser.INTTYPE, MPParser.FLOATTYPE]:
                self.enterOuterAlt(localctx, 1)
                self.state = 18
                self.vardecl()
                self.state = 19
