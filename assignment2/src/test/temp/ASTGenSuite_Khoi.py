...
class ASTGenSuite(unittest.TestCase):
    ...
    def test_const_uninitialized(self):
        ...
        expect = "Program([ClassDecl(Id(Program),[MethodDecl(Id(main),Static,[],Block([ConstDecl(Id(a),ClassType(Id(Sth)),None)]))])])"
...
Class Program {
  main() {
    ...
    def test_complex_program_2(self):
        ...
        expect = "Program([ClassDecl(Id(C),[MethodDecl(Id(func),Instance,[],Block([Return(Id(somethingFun))]))]),ClassDecl(Id(B),[AttributeDecl(Instance,ConstDecl(Id(a),ClassType(Id(C)),None)),MethodDecl(Id(Constructor),Instance,[],Block([AssignStmt(Id(a),NewExpr(Id(C),[])),Return()]))]),ClassDecl(Id(A),[AttributeDecl(Static,ConstDecl(Id($b),ClassType(Id(B)),None)),MethodDecl(Id(Constructor),Instance,[],Block([AssignStmt(FieldAccess(Id(A),Id($b)),NewExpr(Id(B),[])),Return()]))]),ClassDecl(Id(Program),[MethodDecl(Id(mainA),Instance,[],Block([ConstDecl(Id(a),ClassType(Id(A)),NewExpr(Id(A),[])),Call(FieldAccess(FieldAccess(Id(a),Id($b)),Id(a)),Id(func),[]),Return()]))])])"
    ...
    def test_assign_1(self):
        ...
        expect = "Program([ClassDecl(Id(Program),[MethodDecl(Id(main),Static,[],Block([AssignStmt(Id(a),IntLit(1))]))])])"
