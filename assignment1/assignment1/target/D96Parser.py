...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\62\5\3\2\2\2\63\64\7\26\2\2\64\65\7\f\2\2\65\66\7:\2")
        buf.write("\2\66\67\5\b\5\2\678\7;\2\28\7\3\2\2\29:\7\f\2\2:\t\3")
        ...
        buf.write("\2\2\2RT\5\20\t\2SR\3\2\2\2ST\3\2\2\2TU\3\2\2\2UV\7\f")
        ...
        buf.write("rt\7\r\2\2sq\3\2\2\2sr\3\2\2\2t#\3\2\2\2uv\7\13\2\2vx")
...
class D96Parser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      ...
                      "ALPHABET", "ID", "INTLIT", "BREAK", "FOREACH", "INT", 
    ...
    class ImmuttableContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitImmuttable" ):
                return visitor.visitImmuttable(self)
            else:
                return visitor.visitChildren(self)
    ...
    class MuttableContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitMuttable" ):
                return visitor.visitMuttable(self)
            else:
                return visitor.visitChildren(self)
